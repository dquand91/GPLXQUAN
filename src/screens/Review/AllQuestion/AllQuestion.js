...
import {setCurrentAllQuestion} from '../../../redux/allQuestion/actions';

const titleText = 'Tất cả câu hỏi';
...
const allQuestionList = listQuestion;
...
class AllQuestion extends Component {
  ...
  render() {
    console.log(
      'AllQuestion render currentQuestion',
...
function mapStateToProps(state) {
  return {
    currentQuestion: state.AllQuestionReducer.currentQuestion,
  };
}

const mapDispatchToProps = dispatch => ({
  setCurrentQuestion: question => dispatch(setCurrentAllQuestion(question)),
});
